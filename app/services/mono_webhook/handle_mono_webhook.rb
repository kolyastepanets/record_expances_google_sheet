  ...
  class HandleMonoWebhook
    ...
    def call
      ...
      when FOP_DOLLAR_CARD
        MonoWebhook::EnterExpencesFopDollarCardFromWebhook.call(@params[:data][:statementItem])
      when BLACK_UAH_CARD
        MonoWebhook::EnterExpencesUahBlackCardFromWebhook.call(@params[:data][:statementItem])
      end
