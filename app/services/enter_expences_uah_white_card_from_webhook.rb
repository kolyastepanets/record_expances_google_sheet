class EnterExpencesUahWhiteCardFromWebhook < CommonExpensesFromWebhook
  private
  ...
  def call_job
    return PutExpencesUahWhiteCardJob.perform_later(@params) if @params[:category_name].present?
