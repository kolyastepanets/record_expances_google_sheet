    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>8000.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, Badung, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000052255, Counter, :, C2, 11, -, Jul, -, 2023, 07:36:10, NENGAH, MURTINI, 101015010072, ICE, CUBE, 5KG, ], 8,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>12978.0,
          :full_parsed_line=>"P, 101023011534, [, KENTANG, BESAR, ], 14,420 - 1,442"},
         {:category_name=>"Еда",
          :sub_category_name=>"Алкоголь",
          :price=>15624.0,
          :full_parsed_line=>"P, 101023054421, [, PLAGA, FARM, LETTUCE, HEAD, KG, ], 17,360 - 1,736"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>39300.0,
          :full_parsed_line=>"101012009282, [, YUMMY, SOUR, CREAM, 200GR, ], 39,300"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>77500.0,
          :full_parsed_line=>"101012009421, [, LURPAK, SALT, BUTTER, 82, %, 200G, R, ], 77,500"},
         {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>14700.0, :full_parsed_line=>"101012009320, [, TELUR, PUYUH, 20S1, 14,700"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>32000.0,
          :full_parsed_line=>"101002005378, [, KINDER, BUENO, CHOCO, T, -, 21, 32,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>52000.0,
          :full_parsed_line=>"101002008167, [, RITTER, CFLKS100GR, ], 52,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>8383.0,
          :full_parsed_line=>"P, 101024011676, [, PEPAYA, CALINA, KG, ], 9,315 - 932"},
         {:category_name=>"Еда",
          :sub_category_name=>"Колбаса, сосиски",
          :price=>30015.0,
          :full_parsed_line=>"101021011225, [, AROMA, STREAKY, BACON, KG, ], 30,015"},
         {:category_name=>"Еда",
          :sub_category_name=>"Мясо",
          :price=>32683.0,
          :full_parsed_line=>"P, 101016010904, [, CHICKEN, BREAST, KG, ], 36,315 - 3,632"},
         {:category_name=>"Еда",
          :sub_category_name=>"Рыба",
          :price=>26500.0,
          :full_parsed_line=>"101006003395, [, SUNBELL, CHUNKS, OIL, 1, ], 26.500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>79100.0,
          :full_parsed_line=>"101012031654, [, ALBA, GRATED, PARMESAN, 100GR, ], 79,100"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>68000.0,
          :full_parsed_line=>"101002000021, [, LINDT, MRAISIN, NUT100, ], 68,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>18000.0,
          :full_parsed_line=>"P, 101023011646, [, F, TOMAT, CHERY, RED, PC, ], 20,000 - 2,000"}],
        614585.0,
        nil]
      )
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>47900.0,
          :full_parsed_line=>
           "PEPITO, EXPRESS, UMALAS, Jl, ., Dukuh, Indah, 56, Umalas, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000048449, Counter, :, C2, 17, -, Jul, -, 2023, 12:18:14, MONIKA, YANTHI, P, 101010000612, [, HAPPY, DAY, MIXED, JUICE, 1LT, ], 56,500 - 8,600"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>35000.0,
          :full_parsed_line=>"101012008979, (, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35.000"},
         {:category_name=>"Для дома",
          :sub_category_name=>"Кухонные принадлежности",
          :price=>44300.0,
          :full_parsed_line=>"101033016507, [, DETTOL, HAND, SOAP, 2251, 44.300"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>84000.0,
          :full_parsed_line=>"101012009282, [, YUMMY, SOUR, CREAM, 200GR, ), 84.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Бакалея",
          :price=>44700.0,
          :full_parsed_line=>"101006006370, [, BARILLA, SPAGHETTI, NO5, 500, G, R, ], 44,700"},
         {:category_name=>"Еда",
          :sub_category_name=>"Бакалея",
          :price=>102500.0,
          :full_parsed_line=>"101006003597, (, BARILLA, LASAGNAE, 500, GR, ], 102,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>93000.0,
          :full_parsed_line=>"101012033668, [, ARLA, HAVARTI, CHEESE, 150GR, ], 93,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>26000.0,
          :full_parsed_line=>"101066012224, [, TRADITIONAL, TOAST, ], 26,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>55575.0,
          :full_parsed_line=>"P, 101024011772, (, BLUEBERRIES, 125GR, ], 58,500 - 2,925"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>19000.0,
          :full_parsed_line=>"P, 101023011646, [, F, TOMAT, CHERY, RED, PC, ], 20,000 - 1,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Колбаса, сосиски",
          :price=>49500.0,
          :full_parsed_line=>"101013029639, [, MAMAS, STREAKY, BACON, SLC, 250, 49,500"},
         {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>30000.0, :full_parsed_line=>"101012009315, TELUR, MERAH, 105, ], 30.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>14000.0,
          :full_parsed_line=>"101066044428, [, CHOCOLATE, PEANUT, SNICKERS, ], 14,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>8000.0,
          :full_parsed_line=>"101066012151, [, DONUT, SPRINKLE, ], 8.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>8000.0,
          :full_parsed_line=>"101066012153, [, DONUT, CHOCOLATE, ], 8,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>19800.0,
          :full_parsed_line=>"101003007431, [, YAVA, ROASTED, CASHEW, 35GR, ], 19,800"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>8000.0,
          :full_parsed_line=>"101066012156, [, DONUT, BLUEBERRY, ], 8,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>49000.0,
          :full_parsed_line=>"101002005401, (, TOBL, CHO, MILK, 100GR, ], 49,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>65075.0,
          :full_parsed_line=>"P, 101024032325, [, GRAPE, GREEN, MUSCAT, 500, GRI, 68,500 - 3,425"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>40060.0,
          :full_parsed_line=>"P, 101023011627, [, BEEF, TOMATO, RED, KG, ], 42.168 - 2.108"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>16720.0,
          :full_parsed_line=>"P, 101023034624, (, BABY, KYURI, KG, ], 17,600 - 880"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>31407.0,
          :full_parsed_line=>"P, 101023011536, RED, RADISH, ], 33,060 - 1.653"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>37335.0,
          :full_parsed_line=>"P, 101024011744, [, KIWI, GREEN, KG, ], 39,300 - 1,965"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>72500.0,
          :full_parsed_line=>"101003035550, (, THINS, CHICKEN, 175GR, ], 72.500"}],
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>47900.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, Badung, NPWP, :, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000053039, Counter, :, C2, 14, -, Jul, -, 2023, 08:00:48, HEROLINA, AGUSTI, P, 101010052322, [, HAPPY, DAY, FRUIT, JUICE, RASPB, ERRY, APPLE, ], 56,500 - 8,600"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>83000.0,
          :full_parsed_line=>"101012009282, [, YUMMY, SOUR, CREAM, 200GR, ], 83,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>20691.0,
          :full_parsed_line=>"P, 101023034624, [, BABY, KYURI, KG, ], 22,990 - 2,299"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>33782.0,
          :full_parsed_line=>"P, 101023011656, [, DAUN, DIIL, ], 37,536 - 3,754"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>17500.0,
          :full_parsed_line=>"101007001618, [, CAKRA, KBR, TPG, TERIGU, 1KG, ], 17,500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>136000.0,
          :full_parsed_line=>"101002000021, [, LINDT, MRAISIN, NUT100, ], 136,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>21000.0,
          :full_parsed_line=>"101006036766, [, INDOMILK, SKM, PLAIN, 545GR, ], 21,000"},
         ...
         {:category_name=>"Для дома",
          :sub_category_name=>"Кухонные принадлежности",
          :price=>40000.0,
          :full_parsed_line=>"101043020443, [, PC, PHG, ND, PCH800ML, ], 40,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>12500.0,
          :full_parsed_line=>"P, 101002008205, [, KINDER, JOYS, GIRL, 201, 14,500 - 2,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>18000.0,
          :full_parsed_line=>"P, 101023011646, [, F, TOMAT, CHERY, RED, PC, ], 20,000 - 2,000"},
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>27500.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, -, Badung, NPWP, :, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C10000035260, Counter, :, C1, 22, -, Jul, -, 2023, 13:00:22, DEWA, AYU, KADE, S, UARNITI, ASIH, 101015010049, [, WALLS, EXTRA, CREAMY, NEOPOLIT, ANA, 350ML, ), 27,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>63500.0,
          :full_parsed_line=>"101015009983, [, MAGNUM, MINI, ALMOND, 6X45MLJ, 63,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>20884.0,
          :full_parsed_line=>"101024011699, [, MELON, GOLDEN, KG, ], 20,884"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>15900.0,
          :full_parsed_line=>"P, 101002008400, [, HARIBO, WORM, 80GR, ], 19.500 - 3,600"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>20000.0,
          :full_parsed_line=>"101023011646, [, F, TOMAT, CHERY, RED, PC, ], 20.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>48000.0,
          :full_parsed_line=>"101002005378, (, KINDER, BUENO, CHOCO, T, -, 21, 48.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>67500.0,
          :full_parsed_line=>"101012056178, [, ANCHOR, BUTTER, SALTED, PACK, 2, OOGR, ], 67.500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>9000.0,
          :full_parsed_line=>"101002008134, [, DELFI, CHACHA, CHOCO, MILK, 40G, R, ], 9,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>29000.0,
          :full_parsed_line=>"101002008151, [, KINDER, JOY, NATOONS, 20GR, ], 29,000"},
         {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>76482.0, :full_parsed_line=>"1024011713, [, RASPBERRY, LOCAL, KG, 76,482"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>48000.0,
          :full_parsed_line=>"101002005401, [, TOBL, CHO, MILK, 100GR, ], 48,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>67000.0,
          :full_parsed_line=>"101002005406, [, LINDT, WHITE, CHOC100, ], 67,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Яйца",
          :price=>32500.0,
          :full_parsed_line=>"101012009323, [, TELUR, AYAM, NEGERI, ORANGE, 10, S, ], 32,500"}],
        525266.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>73500.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, -, Badung, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000054811, Counter, :, C2, 20, -, Jul, -, 2023, 13:34:35, NENGAH, MURTINI, 101012054384, [, MILK, UP, SOUR, CREAM, 25, %, 330M, L, ], 73,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>72000.0,
          :full_parsed_line=>"101012054382, [, MILK, UP, COTTAGE, CHEESE, 250G, R, ], 72,000"},
         {:category_name=>"Для дома",
          :sub_category_name=>"Кухонные принадлежности",
          :price=>14500.0,
          :full_parsed_line=>"101044020849, [, POLYTEX, SABUT, SPON, ], 14,500"},
         {:category_name=>"Для дома",
          :sub_category_name=>"Кухонные принадлежности",
          :price=>18500.0,
          :full_parsed_line=>"101044020845, [, POLYTX, SERAP, S, ], 18,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>58000.0,
          :full_parsed_line=>"101024011772, [, BLUEBERRIES, 125GR, ], 58,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>22000.0,
          :full_parsed_line=>"101066012226, [, BATARD, BREAD, 300GR, ], 22,000"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>75268.0,
          :full_parsed_line=>"101024011713, [, RASPBERRY, LOCAL, KG, ], 75,268"}],
        361768.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>156000.0,
          :full_parsed_line=>
           "PEPITO, EXPRESS, UMALAS, Jl, ., Dukuh, Indah, 56, Umalas, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000051187, Counter, :, C2, 29, -, Jul, -, 2023, 15:52:28, MONIKA, YANTHI, 101002000021, [, LINDT, MRAISIN, NUT100, ], 156,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>68000.0,
          :full_parsed_line=>"101002005406, [, LINDT, WHITE, CHOC100, ], 68,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>31900.0,
          :full_parsed_line=>"P, 101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35,000 - 3,100"},
         {:category_name=>"Еда",
          :sub_category_name=>"Специи, приправы",
          :price=>40500.0,
          :full_parsed_line=>"101006002145, [, RM, MAYONAISE, LIGHT, ], 40,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Бакалея",
          :price=>56300.0,
          :full_parsed_line=>"101006003640, [, DLV, RISO, 500, GR, ], 56,300"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>75700.0,
          :full_parsed_line=>"101012009184, [, BIOKUL, GR, CRM, MANGGO, 473ML, ], 75,700"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>137500.0,
          :full_parsed_line=>"101003037583, [, KANGAROO, PISTACHIOS, 250GR, ], 137.500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>15000.0,
          :full_parsed_line=>"101002032202DF, CHACHA, MINIS, SURPRISE, 2X, 12.5GR, ), 15,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>18000.0,
          :full_parsed_line=>"101002008134, [, DELFI, CHACHA, CHOCO, MILK, 40G, R, ], 18.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>25000.0,
          :full_parsed_line=>"101002005202, [, KITKAT, CHUNKY, 38GR, ], 25,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>76000.0,
          :full_parsed_line=>"101003035550, (, THINS, CHICKEN, 175GR, ], 76,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>8500.0,
          :full_parsed_line=>"101003008218, [, POCKY, D, CHOC, 47GR, ), 8,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Колбаса, сосиски",
          :price=>49500.0,
          :full_parsed_line=>"101013029639, [, MAMAS, STREAKY, BACON, SLC, 250, GR, ], 49,500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>64395.0,
          :full_parsed_line=>"101024028074, [, ALPUKAT, MENTEGA, SUPER, 500GR, UP, KG, ), 64,395"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>38000.0,
          :full_parsed_line=>"101024011714, [, JERUK, PAMELO, MADU, ], 38,000"}],
        948295.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>127000.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, -, Badung, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C10000038918, Counter, :, C1, 09, -, Aug, -, 2023, 17:33:04, NENGAH, MURTINI, 101015009983, [, MAGNUM, MINI, ALMOND, 6X45MLJ, 127,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>35000.0,
          :full_parsed_line=>"101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>68000.0,
          :full_parsed_line=>"101024032325, (, GRAPE, GREEN, MUSCAT, 500, GR, ), 68,000"},
         {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>90009.0, :full_parsed_line=>"101024027472, [, JERUK, SHANTANG, ], 90,009"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>41500.0,
          :full_parsed_line=>"101003048125, [, TARI, BALI, MEMAN, KACANG, 300G, R, ], 41,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>9000.0,
          :full_parsed_line=>"101012034578, [, GREENFIELDS, KDS, PCH, STRAWBE, RRY, 110GR, ], 9,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>77500.0,
          :full_parsed_line=>"101002005404, [, TDEL, CHO, MILK, 200GRI, 77,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>76482.0,
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>15500.0,
          :full_parsed_line=>"101012009126, [, GREENFIELDS, YOG, MANGO, 125GR, 15,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>15500.0,
          :full_parsed_line=>"101012009124, [, GREENFIELDS, YOG, BLUEBERRY, 1, 25GR, ], 15,500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>36000.0,
          :full_parsed_line=>"101002005202, (, KITKAT, CHUNKY, 38GR, ], 36,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>30500.0,
          :full_parsed_line=>"101002027294, [, MONGGO, DARK, 58, %, 401, 30,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>67000.0,
          :full_parsed_line=>"101002005406, [, LINDT, WHITE, CHOC100, ], 67.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>11000.0,
          :full_parsed_line=>"101002039973, [, CHOMP, CHOMP, THST, MLLW, 60GR, ], 11,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>19500.0,
          :full_parsed_line=>"101002008400, [, HARIBO, WORM, 80GR, ], 19,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>9000.0,
          :full_parsed_line=>"101002008134, [, DELFI, CHACHA, CHOCO, MILK, 40G, 9,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>18000.0,
          :full_parsed_line=>"101066012182, [, HAMBURGER, BUN, 6PCS, ], 18,000"}],
        887491.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>15000.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, -, Badung, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C20000066577, Counter, :, C2, 03, -, Sep, -, 2023, 08:59:41, NENGAH, MURTINI, 101007001617, [, KUNCI, BR, TPG, TRG, 1KG, ], 15.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Мясо",
          :price=>45187.0,
          :full_parsed_line=>"P, 101016010898, [, CHICKEN, BROILER, KG, ), 50,208 - 5,021"},
         {:category_name=>"Еда",
          :sub_category_name=>"Мясо",
          :price=>43200.0,
          :full_parsed_line=>"P, 101016010898, [, ICHICKEN, BROILER, KG, ), 48,000 - 4,800"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>35000.0,
          :full_parsed_line=>"101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35,000, 35,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Вода",
          :price=>66000.0,
          :full_parsed_line=>"101010052322, HAPPY, DAY, FRUIT, JUICE, RASPB, ERRY, APPLE, 66.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>154000.0,
          :full_parsed_line=>"101002000021, (, LINDT, MRAISIN, NUT100, ], 154,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>67000.0,
          :full_parsed_line=>"101002005405, (, LINDT, MILK, 100GR, ], 67,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>67000.0,
          :full_parsed_line=>"101002005406, (, LINDT, WHITE, CHOC1001, 67,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>21000.0,
          :full_parsed_line=>"101006036766, (, INDOMILK, SKM, PLAIN, 545GR, ], 21,000"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>24924.0,
          :full_parsed_line=>"101021011201, (, AROMA, PORK, HONEY, HAM, KG, ], 24,924"},
         {:category_name=>"Еда",
          :sub_category_name=>"Колбаса, сосиски",
          :price=>15500.0,
          :full_parsed_line=>"101013029616, (, HALAL, CHICKEN, BREAKFAST, SLI, DE, 100GR, ), 15,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Колбаса, сосиски",
          :price=>71800.0,
          :full_parsed_line=>"101013041053, TRIPLE, THREE, STREAKY, BACON, 100GR, ], 71,800"},
         {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>13802.0, :full_parsed_line=>"P, 101023011599, (, KYURI, ], 16.238 - 2,436"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>69926.0,
          :full_parsed_line=>"P, 101024011713, (, RASPBERRY, LOCAL, KG, ], 77,696 - 7,770"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>8694.0,
          :full_parsed_line=>"P, 101023011531, (, WORTEL, MEDAN, ], 9,660 - 966"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>18302.0,
          :full_parsed_line=>"P, 101024011733, [, APEL, RED, WASHINGTON, ], 20,336 - 2,034"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>20782.0,
          :full_parsed_line=>"P, 101024011709, (, ALPUKAT, KG, ], 23,091 - 2,309"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>12172.0,
          :full_parsed_line=>"P, 1010240265421PEAR, CENTURY, KG, ], 13,524 - 1.352"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>10546.0,
          :full_parsed_line=>"P, 101024011686, JERUK, NIPIS, KG, ], 11.718 - 1,172"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>40219.0,
          :full_parsed_line=>"P, 101023011627, [, BEEF, TOMATO, RED, KG, ], 44,688 - 4.469"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>52200.0,
          :full_parsed_line=>"P, 101024011772, (, BLUEBERRIES, 125GR, ], 58,000 - 5,800"},
         {:category_name=>"Еда",
          :sub_category_name=>"Яйца",
          :price=>32500.0,
          :full_parsed_line=>"1010120093230TELUR, AYAM, NEGERI, ORANGE, 10, 32,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Овощи",
          :price=>9266.0,
          :full_parsed_line=>"P, 101023011656, (, DAUN, DIIL, ], 10,296 - 1.030"},
         {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1728.0, :full_parsed_line=>"P, 101023011657, [, PARSLEY, ], 1.920 - 192"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>23809.0,
          :full_parsed_line=>"P, 101024011683, (, SUNPRIDE, PISANG, CAVENDISH, K, G, ], 26,455 - 2,646"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>33000.0,
          :full_parsed_line=>"101066012240, (, WHITE, SOUR, DOUGH, BRO, ], 33.000"},
         {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>9000.0, :full_parsed_line=>"101002005481, (, DELFI, ZAP, CHOC, 421, 9.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>9000.0,
          :full_parsed_line=>"101002005204, (, DELFI, NOCKERS, 45GR, ], 9.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>14700.0,
          :full_parsed_line=>"P101002005482, [, DELFI, BUZZA, 20GR, ], 19.500 - 4,800"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>37500.0,
          :full_parsed_line=>"101002005202, (, KITKAT, CHUNKY, 38GR, ], 37.500"},
         ...
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>90000.0,
          :full_parsed_line=>"101002005717, (, REESES, NUT, BAR, 1.661, 90.000"}],
        1256258.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1] - 1)
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>21210.0,
          :full_parsed_line=>
           "PEPITO, EXPRESS, UMALAS, Jl, ., Dukuh, Indah, 56, Umalas, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, JL.KEDIRI, NO.36, A, ,, TUBAN, KUTA, BADUNG, -, BAL, Item, Sales, Bill, No, :, 5C20000065628, Counter, :, C2, 29, -, Sep, -, 2023, 18:35:04, WILDA, TRI, RAMDA, 101024011709, [, ALPUKAT, KG, ], 21.210"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>76421.0,
          :full_parsed_line=>"101024011713, (, RASPBERRY, LOCAL, KG, ], 76,421"},
         {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>21890.0, :full_parsed_line=>"101023034624, [, BABY, KYURI, KG, ], 21,890"},
         {:category_name=>"Еда",
          :sub_category_name=>"Яйца",
          :price=>26500.0,
          :full_parsed_line=>"101012009324, [, TELUR, AYAM, NGRI, 10S, ], 26,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>35000.0,
          :full_parsed_line=>"101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>61900.0,
          :full_parsed_line=>"P, 101012056178, [, ANCHOR, BUTTER, SALTED, PACK, 2, OOGR, ], 69,500 - 7,600"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>61900.0,
          :full_parsed_line=>"P, 101012056179, [, ANCHOR, BUTTER, UNSALTED, PACK, 200GR, ], 69,500 - 7,600"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>87000.0,
          :full_parsed_line=>"101012009282, [, YUMMY, SOUR, CREAM, 200GR, ], 87,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>33000.0,
          :full_parsed_line=>"101012009125, (, GREENFIELDS, YOG, STRAW, 125GR, 33,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>33000.0,
          :full_parsed_line=>"101012009124, [, GREENFIELDS, YOG, BLUEBERRY, 1, 25GR, ], 33,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>9000.0,
          :full_parsed_line=>"101002005204, [, DELFI, NOCKERS, 45GR, ], 9.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>28084.0,
          :full_parsed_line=>"101024011683, [, SUNPRIDE, PISANG, CAVENDISH, K, G, ], 28,084"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>16500.0,
          :full_parsed_line=>"101012009126, (, GREENFIELDS, YOG, MANGO, 125GR, 16,500"},
         {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>51000.0, :full_parsed_line=>"101003007398, [, MATAHARI, K, BW, 5001, 51,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>27000.0,
          :full_parsed_line=>"101066012224, [, TRADITIONAL, TOAST, ], 27,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>107500.0,
          :full_parsed_line=>"101002053595, (, KITKAT, MINI, STRAWBERRY, 124G, R, ], 107,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"К пиву",
          :price=>14000.0,
          :full_parsed_line=>"101003041480, [, PRINGLES, CHEESY, CHEESE, 42GR, 14.000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>14500.0,
          :full_parsed_line=>"101024044757, [, NANAS, MADU, SLICE, 4S, PCS, ], 14.500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>9000.0,
          :full_parsed_line=>"101003028592, [, FULLO, BITZ, VANILLA, MILK, 70G, R, ], 9,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Фрукты",
          :price=>55500.0,
          :full_parsed_line=>"101024032325, [, GRAPE, GREEN, MUSCAT, 500, GR, ), 55,500"}],
        789900.0,
        nil]
      )
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>66000.0,
          :full_parsed_line=>
           "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, Badung, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, Item, Sales, Bill, No, :, 5C10000047724, Counter, :, C1, 26, -, Sep, -, 2023, 14:54:24, KSR, PUTRI, AISAH, 101010000608, [, HAPPY, DAY, STRAWBERRY, 1L, ], 66,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Кофе, Чай",
          :price=>32000.0,
          :full_parsed_line=>"101005007529, [, CHRYSANTHEMUM, CRYST, ], 32,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Хлеб и др",
          :price=>23000.0,
          :full_parsed_line=>"101066012228, [, BROWN, BREAD, 300, GR, ], 23,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Яйца",
          :price=>26000.0,
          :full_parsed_line=>"101012009324, [, TELUR, AYAM, NGRI, 10S, ], 26,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Мясо",
          :price=>13241.0,
          :full_parsed_line=>"P, 101016010915, [, CHICKEN, GIZZARD, KG, ], 13,938 - 697"},
         {:category_name=>"Еда",
          :sub_category_name=>"Мясо",
          :price=>100834.0,
          :full_parsed_line=>"P, 101016053544, (, DUCK, LEG, KG, ], 106,141 - 5,307"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>35000.0,
          :full_parsed_line=>"101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 35.000"},
         {:category_name=>"Для дома",
          :sub_category_name=>"Кухонные принадлежности",
          :price=>26400.0,
          :full_parsed_line=>"101044038238, [, BAGUS, TRASH, BAG, ROLL, 60X80C, 26,400"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>63000.0,
          :full_parsed_line=>"101012009454, [, YUMMY, CREAM, CHEESE, 250GR, ], 63,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>43000.0,
          :full_parsed_line=>"101012009282, [, YUMMY, SOUR, CREAM, 200GR, ], 43,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>34000.0,
          :full_parsed_line=>"101003034554, [, H, &, H, MILK, WAFER, STICK, 90GR, ], 34,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Молочка",
          :price=>92500.0,
          :full_parsed_line=>"101012033668, [, ARLA, HAVARTI, CHEESE, 150GR, ], 92,500"},
         {:category_name=>"Еда",
          :sub_category_name=>"Специи, приправы",
          :price=>9500.0,
          :full_parsed_line=>"101007001434, [, DOLPHIN, GARAM, 200GR, ], 9,500"},
         {:category_name=>"Для дома",
          :sub_category_name=>"инвентарь",
          :price=>15000.0,
          :full_parsed_line=>"101033016494, [, ANTIS, HS, MENTIMUN, SPRAY, 55M, L, ], 15,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>46000.0,
          :full_parsed_line=>"101002054510, [, MILKA, OREO, WHITE, 100GR, ], 46,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>46000.0,
          :full_parsed_line=>"101002054506, [, MILKA, CONFETTI, 100GR, ], 46,000"},
         {:category_name=>"Еда",
          :sub_category_name=>"Сладости",
          :price=>67000.0,
          :full_parsed_line=>"101002005406, [, LINDT, WHITE, CHOC100, ], 67,000"}],
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда",
          ...
          :price=>70000.0,
          :full_parsed_line=>
            "PEPITO, MARKET, SEMER, Banjar, Semer, ,, Kerobokan, -, Badung, NPWP, 02.046.836.9-904.000, PT, Sentral, Retailindo, Dewata, JL.KEDIRI, NO.36, A, ,, TUBAN, KUTA, BADUNG, -, BAL, Item, Sales, Bill, No, :, 5C10000054141, Counter, :, C1, 03, -, Nov, -, 2023, 18:34:03, YUNI, ARTINI, 101012008979, [, GREENFIELDS, FRESH, MILK, FULL, CREAM, 1LT, ], 70,000"},
          {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>42000.0, :full_parsed_line=>"101015009989, [, MAGNUM, CLASSIC, 90ML, ), 42,000"},
          {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>75000.0, :full_parsed_line=>"101024051051, [, GRAPE, RED, NINA, QUEEN, 500GR, ], 75,000"},
          {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>16000.0, :full_parsed_line=>"101012009125, [, GREENFIELDS, YOG, STRAW, 125GR, 16,000"},
          {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>16000.0, :full_parsed_line=>"101012009124, [, GREENFIELDS, YOG, BLUEBERRY, 1, 25GR, ], 16,000"},
          {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>9500.0, :full_parsed_line=>"101012043580, [, GREENFIELDS, KDS, PCH, MIXED, B, ERRY, 110GR, ], 9,500"},
          {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>31455.0, :full_parsed_line=>"101024011726, [, APEL, ROYAL, GALA, NZ, ], 31,455"},
          {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>36860.0, :full_parsed_line=>"101024011744, [, KIWI, GREEN, KG, ], 36,860"}],
        296815.0,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
