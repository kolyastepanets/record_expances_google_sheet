    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Для дома",
         ...
         {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>60500.0, :full_parsed_line=>"23030194, THINS, CHICKEN, 175, GR, 60,500"},
    ...
    it 'return 3 values' do
      ...
      expect(result).to eq(
        [[{:category_name=>"Еда", :sub_category_name=>"Вода", :price=>16000.0, :full_parsed_line=>"20000005, COCA, COLA, PET, 1500ML, 16,000"},
          ...
          {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>66500.0, :full_parsed_line=>"23030194, THINS, CHICKEN, 175, GR, 66, ,, 500"},
          {:category_name=>"Еда",
           :sub_category_name=>"Сладости",
           :price=>202500.0,
