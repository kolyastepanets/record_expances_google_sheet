...
RSpec.describe PricesFromImage, vcr: true do
  ...
  context 'when receipt tesco 12', freezed_time: '2024-08-26T18:48:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out11.png") }
    ...
    it 'return 3 values' do
      ...
      new_result, sum_of_prices = new_result_and_sum_of_prices(result)
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.5},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>3.15},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.65},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.79},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.6},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.0},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>6.0},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.85},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.89},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.55},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.25},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.3},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.99},
        ...
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>6.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.8},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.75},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.79},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>3.25},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>1.4},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.4},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>2.65},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.6},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.04},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.0},
  ...
  context 'when receipt tesco 13', freezed_time: '2024-09-04T08:10:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out12.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        ...
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.65},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.25},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.0},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.56},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.85},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.5},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.25},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.05},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.5},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.59},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.35},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.5},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.4},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.5},
        ...
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.6},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.7},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.0},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.2},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>1.95},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.4},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.59},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.15},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.3},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.45},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.52},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>7.0},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.6},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.65},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.3},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.46},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>3.98},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>2.7},
        118.14,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
  ...
  context 'when receipt tesco 14', freezed_time: '2024-10-08T09:28:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out14.png") }
    ...
    it 'return 3 values' do
      ...
      new_result, sum_of_prices = new_result_and_sum_of_prices(result)
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.62},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>5.62},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.47},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.94},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.55},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.29},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.81},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.56},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.13},
        {:category_name=>"Еда", :sub_category_name=>"Колбаса, сосиски", :price=>1.81},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.16},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.46},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.46},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.75},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.62},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>2.96},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.88},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.95},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.88},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.76},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>3.52},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.14},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>2.96},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.9},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.42},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.88},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>3.76},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.91},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>2.48},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.42},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.88},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>1.04},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.42},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.95},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>0.95},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.75},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.87},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>1.84},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>3.76},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>5.13},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.14},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.95},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>2.76},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.75},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.6},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.61},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.06},
        {:category_name=>"Для дома", :sub_category_name=>"инвентарь", :price=>2.81},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>3.29},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>5.83},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.5},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.71},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.42},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>5.64},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>3.22},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>2.81},
        137.26,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
  ...
  context 'when receipt tesco 15', freezed_time: '2024-10-15T08:25:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out15.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        ...
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.1},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.8},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>6.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.65},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.3},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.14},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>1.39},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.2},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.25},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.39},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.35},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.85},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.69},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.82},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.8},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.4},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.35},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>5.55},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.25},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>10.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.95},
        ...
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Полуфабрикаты/морозилка", :price=>1.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.4},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>2.3},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.52},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.25},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.3},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.52},
  ...
  context 'when receipt tesco 17', freezed_time: '2024-11-22T13:29:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out17.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.75},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>3.75},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.62},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.79},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.35},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.8},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.95},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.98},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>5.9},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>6.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.65},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.35},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>6.25},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.5},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>6.3},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.19},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>2.75},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.25},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>2.7},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>1.2},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.47},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.09},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>1.35},
        ...
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>2.7},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.0},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.95},
        107.54,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
  ...
  context 'when receipt tesco 18', freezed_time: '2024-12-01T12:47:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out18.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        ...
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>6.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.56},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.95},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.95},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.0},
        ...
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.75},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>0.46},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Бакалея", :price=>2.3},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.9},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>2.65},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.99},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.89},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>10.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.47},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.75},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>5.95},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>0.89},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.79},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>1.95},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>6.7},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.49},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.3},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.35},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.52},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.75},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>3.98},
  ...
  context 'when receipt tesco 19', freezed_time: '2024-12-10T21:48:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out19.png") }
    ...
    it 'return 3 values' do
      ...
      new_result, sum_of_prices = new_result_and_sum_of_prices(result)
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>3.8},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>6.45},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.45},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.25},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.2},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.35},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.95},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.5},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>2.68},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>5.1},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.6},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.4},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.56},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.0},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.45},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.59},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.9},
        {:category_name=>"Еда", :sub_category_name=>"Готовая", :price=>1.55},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.89},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.25},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>10.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.2},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.5},
        {:category_name=>"Для дома", :sub_category_name=>"инвентарь", :price=>1.99},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.52},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.75},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.75},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.4},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>6.45},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>2.7},
        113.02,
        nil]
      )
  ...
  context 'when receipt tesco 20', freezed_time: '2025-01-06T09:39:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out20.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.13},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.12},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.89},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>2.84},
        {:category_name=>"Еда", :sub_category_name=>"Колбаса, сосиски", :price=>1.89},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.22},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.64},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>3.79},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.81},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.95},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.94},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.2},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.31},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>4.92},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.54},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.81},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.41},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.79},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>3.88},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.94},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.65},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.19},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.43},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.27},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.8},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.37},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.9},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.89},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.19},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.37},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.57},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.91},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>6.59},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.5},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.72},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.95},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.62},
  ...
  context 'when receipt tesco 21', freezed_time: '2025-01-13T09:14:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/tesco/out21.png") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        [{:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>4.0},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>9.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>4.5},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>5.1},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.57},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>3.4},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.0},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.2},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.9},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>5.8},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>4.7},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>4.55},
        {:category_name=>"Еда", :sub_category_name=>"Колбаса, сосиски", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>2.6},
        {:category_name=>"Еда", :sub_category_name=>"Полуфабрикаты/морозилка", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>5.0},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.8},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.59},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>6.3},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>1.44},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.4},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.15},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.15},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>3.5},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>9.95},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.7},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.5},
        {:category_name=>"Еда", :sub_category_name=>"К пиву", :price=>1.35},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.9},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.75},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.0},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>0.55},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.5},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.0},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.6},
        112.74,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
  ...
  context 'when receipt lidl 33', freezed_time: '2024-08-20T13:02:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/lidl/out33.jpeg") }
    ...
    it 'return 3 values' do
      ...
      new_result, sum_of_prices = new_result_and_sum_of_prices(result)
      expect(new_result).to eq(
        [{:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>2.39},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.55},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.89},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>3.15},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.65},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.69},
        {:category_name=>"Для дома", :sub_category_name=>"Ванные принадлежности", :price=>3.99},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.48},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>0.39},
        15.18,
        nil]
  ...
  context 'when receipt lidl 35', freezed_time: '2024-09-18T12:47:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/lidl/out35.jpeg") }
    ...
    it 'return 3 values' do
      ...
      new_result, sum_of_prices = new_result_and_sum_of_prices(result)
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>4.58},
        {:category_name=>"Еда", :sub_category_name=>"Вода", :price=>1.99},
        6.57,
        nil]
      )
      expect(sum_of_prices).to eq(result[1])
  ...
  context 'when receipt lidl 36', freezed_time: '2024-09-27T16:56:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/lidl/out36.jpeg") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        [{:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.79},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.65},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>4.49},
        {:category_name=>"Еда", :sub_category_name=>"Рыба", :price=>2.99},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.09},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.75},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.19},
        {:category_name=>"Еда", :sub_category_name=>"Кофе, Чай", :price=>2.89},
        {:category_name=>"Еда", :sub_category_name=>"Яйца", :price=>1.79},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.48},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.19},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.79},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>3.99},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.59},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.59},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>1.99},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.88},
        {:category_name=>"Еда", :sub_category_name=>"Колбаса, сосиски", :price=>5.74},
        {:category_name=>"Еда", :sub_category_name=>"Специи, приправы", :price=>0.98},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.89},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.79},
        47.53,
        nil]
  ...
  context 'when receipt lidl 37', freezed_time: '2024-09-30T18:52:00+00:00' do
    let(:get_telegram_image) { File.read("spec/images/lidl/out37.jpeg") }
    ...
    it 'return 3 values' do
      ...
      expect(new_result).to eq(
        ...
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>1.39},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>1.25},
        {:category_name=>"Для дома", :sub_category_name=>"Кухонные принадлежности", :price=>0.85},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>4.99},
        {:category_name=>"Еда", :sub_category_name=>"Мясо", :price=>5.59},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.09},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>1.39},
        {:category_name=>"Еда", :sub_category_name=>"Хлеб и др", :price=>2.69},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.75},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>3.75},
        {:category_name=>"Еда", :sub_category_name=>"Сладости", :price=>2.58},
        {:category_name=>"Для дома", :sub_category_name=>"инвентарь", :price=>7.78},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.69},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.69},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>0.88},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.79},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>2.38},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>1.49},
        {:category_name=>"Еда", :sub_category_name=>"Овощи", :price=>0.59},
        {:category_name=>"Еда", :sub_category_name=>"Молочка", :price=>0.99},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>2.69},
        {:category_name=>"Еда", :sub_category_name=>"Фрукты", :price=>1.59},
        52.01,
        nil]
      )
